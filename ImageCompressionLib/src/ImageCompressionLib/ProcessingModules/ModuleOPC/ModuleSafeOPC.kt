...
class ModuleSafeOPC :AbsModuleOPC{
    ...
    constructor(tripleShortOld: TripleShortMatrixOld, flag: Flag, message: String?, sameBase: Size) : super(tripleShortOld, flag) {
        this.message = message
        this.sameBase = sameBase
//        imageSize!!.imSize
    }
    constructor(tripleDataOpcOld: TripleDataOpcMatrixOld, flag: Flag, sameBase: Size, imSize: Size) : super(tripleDataOpcOld, flag) {
//        this.message = message
        this.sameBase = sameBase
        imageSize=imSize
    }
//    val ipu=ImageProcessorUtils()
    ...
    override fun direct(tripleShortOld: TripleShortMatrixOld): TripleDataOpcMatrixOld {
        val tmp= tripleShortOld.toTripleContainer()
        val m= if(message!=null)MessageParser().fromString(message!!) else null
        moduleStego.direct(tmp,m,isDivTwo)
        return tripleDataOpcOld!!
    }
    override fun reverce(tripleDataOpcOld: TripleDataOpcMatrixOld): TripleShortMatrixOld {
        val tmp = tripleDataOpcOld.toTripleContainer()
        moduleStego.reverse(tmp,sameBase.width, sameBase.height, isMultiTWO)
        return tripleShortOld!!
    }

    fun TripleDataOpcMatrixOld.toTripleContainer():ImageProcessorUtils.Triple<IContainer<OpcContainer<Short>>>{
    ...
    fun ImageProcessorUtils.Triple<IContainer<OpcContainer<Short>>>.toTripleDataOpcMatrix(): TripleDataOpcMatrixOld {
        val res= TripleDataOpcMatrixOld()
    ...
    fun TripleShortMatrixOld.toTripleContainer():ImageProcessorUtils.Triple<IContainer<UnitContainer<Short>>>{
//        val res= TripleShortMatrixOld(0,0,State.Yenl)
    ...
    fun ImageProcessorUtils.Triple<IContainer<UnitContainer<Short>>>.toTripleShortMatrix(): TripleShortMatrixOld {
        val res= TripleShortMatrixOld(0,0,ImageCompressionLib.Constants.State.Yenl)

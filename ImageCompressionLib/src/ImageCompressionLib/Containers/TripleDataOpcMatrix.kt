...
//        parameters.toByteVector(v1)
    ...
    companion object {
        ...
        @JvmStatic
        fun valueOf(container: ByteVectorContainer): TripleDataOpcMatrix {
//            val parameters=Parameters.fromByteVector(container.mainData)
            ...
            val v2 =
                if (parameters.flag.isChecked(Flag.Parameter.OneFile)) container.mainData else container.suportData

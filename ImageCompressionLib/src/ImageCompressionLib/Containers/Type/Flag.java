...
public class Flag {
    ...
    public enum Parameter {
        ...
        /*Password(512)/*,Steganography(1024),*/Alignment(2048), CompressionUtils(4096), Quantization(1), Encryption(4), DCT(2), ByteBase(8);
        final int value;
    ...
    private Encryption getEncryption() {
        ...
        switch (e) {
            case 0:
                return Encryption.Without;
            case 4:
                return Encryption.First;
            default:
                return null;
        }
    }
